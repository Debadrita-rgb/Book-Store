  ...
  useEffect(() => {
    const fetchTransporter = async () => {
      try {
        ...
        const res = await fetch(`${BASE_URL}/company/get-single-transporter/${id}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
...
// console.log("Form Data:", formData);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/company/update-transporter-details/${id}`, {
        method: "PUT",
        headers: {
...
export default EditCompanyTransporter;
