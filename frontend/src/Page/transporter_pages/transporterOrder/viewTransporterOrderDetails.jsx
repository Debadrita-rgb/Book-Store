...
const ViewTransporterOrderDetails = () => {
  ...
  const fetchOrder = async () => {
    ...
    const res = await axios.get(
      `${BASE_URL}/admin/get-single-order-details/${orderId}`,
      {
        headers: {
  ...
  const updateStatus = async () => {
    ...
    await axios.put(
      `${BASE_URL}/admin/update-order-status/${order._id}`,
      {
        orderStatus: status,
      },
      {
...
export default ViewTransporterOrderDetails;
